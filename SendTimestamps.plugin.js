/**
 * @name SendDiscordTimestamps
 * @author fuzzyfurry069
 * @description Sending uniform timestamps into discord made easy! Updated from the last abandoned version. Credits to Taimoor for the code, I simply updated it.
 * @version 1.0
 * @authorId 399436902475759626
 * @authorLink https://github.com/fuzzyfurry069
 * @website https://dumbfuzzywolf.gay
 * @source https://github.com/fuzzyfurry069/SendTimestamps
 */
...
module.exports = (() => {
    const config = {
        info: { name: 'SendDiscordTimestamps', version: '1.0.0', description: 'Sending uniform timestamps into discord made easy!', author: 'Fuzzy Wilson, Taimoor', authorId: '399436902475759626, 220161488516546561', authorLink: 'https://github.com/fuzzyfurry069, https://github.com/Taimoor-Tariq', source: 'https://github.com/fuzzyfurry069/SendTimestamps', authors: [{ name: 'Taimoor', discord_id: '220161488516546561' }, { name: 'Fuzzy Wilson', discord_id: '399436902475759626'}] },
        changelog: [
            { title: 'v3.0.0 - Bug Fixes', items: ['Updated code so plugin functions with the help of pull requests. Hopefully the original creator comes back. ~FW'] },
        ],
        main: 'index.js',
    };
